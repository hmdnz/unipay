...
<head>
    ...
    <title>MAXUTILITY | Buy Education </title>
                ...
                <div class="col-md-7 mx-auto">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title">Buy Education</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="container">
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="fname">Select Exam</label>
                                            <select class="form-control" id="disco" required>
                                                <option value="">Select..</option>
                                                <option value="GOTV">WAEC</option>
                                                <option value="DSTV">NECO</option>
                                                <option value="STARTIMES">JAMB</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="fname">Quantity</label>
