...
<head>
    ...
    <title>MAXUTILITY | Buy Airtime</title>
                        ...
                        <div class="card-body p-3">
                            <div class="container">
                                <form id="airtime-topup-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control" name="category" id="category">
                                                ...
                                                <option value="ShareSale">Share & Sale</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-primary col-12" id="buy-airtime-button" onclick="processBuyAirtime(event)"><span id='buyAirtimeButtonpaySpan'></span> Recharge Now <span id="total-span"></span></button>
                                </form>
                            </div>
                        </div>
                    </div>
